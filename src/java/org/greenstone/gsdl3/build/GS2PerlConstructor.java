...
/** CollectionConstructor class for greenstone 2 compatible building
 * it uses the perl scripts to do the building stuff */
public class GS2PerlConstructor 
    ...
    /** gsdlhome for greenstone 2 - we use the perl modules and building 
     * scripts from there */
