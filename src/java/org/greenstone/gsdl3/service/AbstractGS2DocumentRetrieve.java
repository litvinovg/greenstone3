...
public abstract class AbstractGS2DocumentRetrieve
    ...
    */
	...
	if (temp.equals("parent") || temp.equals("root") || temp.equals( "ancestors")) { // "current" "siblings" "children" "descendants"
	    relation = temp;
	    pos = metadata.indexOf(GSConstants.META_RELATION_SEP);
	    if (pos == -1) {
		temp = "";
    ...
    /** needs to get info from collection database - if the calling code gets it already it may pay to pass it in instead */
