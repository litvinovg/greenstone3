    ...
    extends ServiceRack 
{
    ...
    /** Sets up the short service info for service by QUERY_SERVICE 
     *	  (e.g. TextQuery or AudioQuery)
     *  If other services will be provided, should be added in the
     *  subclass configure also looks for search format info, and
    ...
    /** returns a basic description for QUERY_SERVICE. If a subclass 
     * provides other services they need to provide their own descriptions */
     ...
     * other common ones index, maxDocs, hitsPerPage, startPage
    */
