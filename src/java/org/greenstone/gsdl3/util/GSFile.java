...
public class GSFile {
  ...
  /** the collection database file - */
    static public String collectionDatabaseFile(String site_home, 
						String collection_name,
						String index_stem, 
    ...
    /** Recursively moves the contents of source file to destination,
     * maintaining paths.
     * @param source A File representing the directory whose contents you
     * wish to move.
     * @param destination A File representing the directory you wish to move
     * files to.
