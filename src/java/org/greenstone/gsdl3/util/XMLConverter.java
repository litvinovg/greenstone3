...
public class XMLConverter {
	...
	if (nodeType == Node.DOCUMENT_NODE) {
	    ...
	    String message = "Expecting Document or Element node type but got " 
		+ node.getNodeName() + "\nReturning null";
     ...
     * For more info see 
     * http://xerces.apache.org/xerces-j/apiDocs/org/apache/xerces/dom/DocumentTypeImpl.html#DocumentTypeImpl(org.apache.xerces.dom.CoreDocumentImpl,%20java.lang.String)
     * 
     * */
     ...
     * text nodes if the String is read back in as a DOM, so should only be 
     * used for printing */
