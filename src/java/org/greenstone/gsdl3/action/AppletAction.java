...
Element applet_info = GSXML.getFirstElementChild(GSXML.getNodeByPath(mr_response, path));
     ...
     * 'library' or 'collection'. If found, the params are set to  
     * the appropriate values 
     * should this be done here or in the receptionist? 
     */
    protected void editLocalParams(Element description, String library_name,
