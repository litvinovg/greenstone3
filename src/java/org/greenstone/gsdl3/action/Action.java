...
abstract public class Action {
    ...
    /** a reference to the message router that it must talk to to
     * get info. it may be a communicator acting as a proxy, but it 
    ...
    /** process takes an xml representation of cgi args
     * and returns the page of results - may be in html/xml/other
     * depending on the output att of the request */
     ...
     * Useful for adding the current site's metadata to a response before sending it
     *
     * @param  element   the element to add site metadata to
