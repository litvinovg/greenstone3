...
public class OAIServer extends BaseGreenstoneServlet
{
	...
	/**
	 * a converter class to parse XML and create Docs This is only used for
	 * generating internal requests passed to MessageRouter. The response
	 * message is generated by parsing an existing xml skeleton file
	 * (web/WEB-INF/oaixml/oaiversion2.xml, for example).
	 */
	protected XMLConverter converter = null;
	/**
	 * container Document to create XML Nodes (but only request to the oai
	 * receptionist, not response (which is created in OAIXML.java) created by
	 * converter class
	 */
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		else
		{
			...
			if (OAIXML.oai_version.equals(OAIXML.OAI_VERSION2) || verb_elem.getTagName().equals(OAIXML.ERROR))
			{
