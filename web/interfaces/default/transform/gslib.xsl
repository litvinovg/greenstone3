...
<xsl:stylesheet version="1.0" 
  ...
  <xsl:template name="groupLinkWithImage">
    ...
    <xsl:variable name="coll_href"><xsl:value-of select="$library_name"/>?a=p&amp;sa=home&amp;group=<xsl:value-of select="/page/pageRequest/paramList/param[@name='group']/@value"/>/<xsl:value-of select="@name"/></xsl:variable>
    <xsl:choose>
