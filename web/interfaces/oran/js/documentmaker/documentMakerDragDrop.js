...
function documentMakerDDStack(id, sGroup) {
	if (id) {
		this.init(id, sGroup);
		this.initFrame();
	}
...
documentMakerDDStack.prototype = new YAHOO.util.DDTarget();

documentMakerDDPlayer.TYPE = "documentMakerDDPlayer";
...
*/
function documentMakerDDPlayer(id, sGroup, bl) {
	this.initPlayer(id, sGroup);
	this.berryList = bl;     
	
}

documentMakerDDPlayer.prototype = new YAHOO.util.DDProxy();

documentMakerDDPlayer.prototype.berryList = new Array();

documentMakerDDPlayer.prototype.initPlayer = function(id, sGroup) {
	if (!id) { return; }
	...
	this.type = documentMakerDDPlayer.TYPE;
	this.slot = null;
	this.startPos = YAHOO.util.Dom.getXY( this.getEl() );

}

documentMakerDDPlayer.prototype.startDrag = function(x, y) {
...
documentMakerDDPlayer.prototype.getTargetDomRef = function(oDD) {
	if (oDD.player) {
...
documentMakerDDPlayer.prototype.endDrag = function(e) {
...
documentMakerDDPlayer.prototype.resetTargets = function() {
...
documentMakerDDPlayer.prototype.onDragDrop = function(e, id) {
	...
	var addSuccess = function(o){
		...
		if (items.length > 0){
			var item = items[0];
			var berrybasket = YAHOO.util.Dom.get('documentmaker');
			var berries = YAHOO.util.Dom.get('documentpages');
...
documentMakerDDPlayer.prototype.swap = function(el1, el2) {
...
documentMakerDDPlayer.prototype.onDragOver = function(e, id) {};

documentMakerDDPlayer.prototype.onDrag = function(e, id) {};
